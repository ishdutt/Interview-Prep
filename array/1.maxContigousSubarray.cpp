...
//1. KADANE'S ALGORITHM O(N**2) HERE NEGATIVE NUMBERS ARE MUST SINCE IT DOES'NT MAKE SENSE TO INCLUDE THE + ONLY
// AS ALL WILL CONTRIBUTE OT THE INCREMENT OF CURRENT SUM
